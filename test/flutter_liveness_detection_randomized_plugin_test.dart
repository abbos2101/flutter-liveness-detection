...
void main() {
  final FlutterLivenessDetectionRandomizedPluginPlatform initialPlatform =
      FlutterLivenessDetectionRandomizedPluginPlatform.instance;

  test(
    '$MethodChannelFlutterLivenessDetectionRandomizedPlugin is the default instance',
    () {
      expect(
        initialPlatform,
        isInstanceOf<MethodChannelFlutterLivenessDetectionRandomizedPlugin>(),
      );
    },
  );
  ...
  test('getPlatformVersion', () async {
    ...
    flutterLivenessDetectionRandomizedPlugin =
        FlutterLivenessDetectionRandomizedPlugin.instance;
    MockFlutterLivenessDetectionRandomizedPluginPlatform fakePlatform =
        MockFlutterLivenessDetectionRandomizedPluginPlatform();
    FlutterLivenessDetectionRandomizedPluginPlatform.instance = fakePlatform;

    expect(
      await flutterLivenessDetectionRandomizedPlugin.getPlatformVersion(),
      '42',
    );
  });
}
